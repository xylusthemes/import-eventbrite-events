...
if ( ! class_exists( 'Import_Eventbrite_Events' ) ) :
	...
	class Import_Eventbrite_Events {
		...
		public $common, $cpt, $eventbrite, $admin, $manage_import, $iee, $tec, $em, $eventon, $event_organizer, $aioec, $my_calendar, $ee4;
		...
		public function __clone() {
			_doing_it_wrong( __FUNCTION__, esc_html__( 'Cheatin&#8217; huh?', 'import-eventbrite-events' ), '1.7.0' );
		}
