			...
			<table class="form-table">
				<tbody>
					<tr>
						...
						<td>
							<input class="eventbrite_oauth_token" name="eventbrite[eventbrite_oauth_token]" type="text" value="
							<?php
							if ( isset( $eventbrite_options['eventbrite_oauth_token'] ) ) {
								echo $eventbrite_options['eventbrite_oauth_token']; }
?>
" />
					...
					<tr>
						...
						<td>
							...
							?>
							<input type="checkbox" name="eventbrite[enable_ticket_sec]" value="yes" 
							<?php
							if ( $enable_ticket_sec == 'yes' ) {
 ...
 />
					...
					<tr>
						...
						<td>
							...
							?>
							<input type="checkbox" name="eventbrite[update_events]" value="yes" 
							<?php
							if ( $update_eventbrite_events == 'yes' ) {
								echo 'checked="checked"'; }
?>
 />
							<span class="xtei_small">
					...
					<tr>
						...
						<td>
							...
							?>
							<input type="checkbox" name="eventbrite[advanced_sync]" value="yes" 
							<?php
				...
				<tbody>
					<tr>
						...
						<td>
							...
							?>
							<input type="checkbox" name="eventbrite[deactive_ieevents]" value="yes" 
							<?php
 ...
 />
					...
					<tr>
						...
						<td>
							...
							?>
							<input type="checkbox" name="eventbrite[delete_ieedata]" value="yes" 
							<?php
