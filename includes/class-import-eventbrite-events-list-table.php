...
class Shortcode_List_Table extends WP_List_Table {
    ...
    private function table_data() {
        ...
        $data[] = array(
                    ...
                    'shortcode'     => '<p class="short_code">[eventbrite_events]</p>',
                    'action'     	=> '<button class="btn-copycart button-primary"  data-value="[eventbrite_events]">Copy</button>',
                    );
        $data[] = array(            
                    'id'            => 2,
                    'how_to_use'    => 'Display with column',
					'shortcode'     => '<p class="short_code">[eventbrite_events col="2"]</p>',
					'action'     	=> "<button class='btn-copycart button-primary' data-value='[eventbrite_events col=\"2\"]' >Copy</button>",
                    );
        $data[] = array(
                    'id'            => 3,
                    'how_to_use'    => 'Limit for display events',
					'shortcode'     => '<p class="short_code">[eventbrite_events posts_per_page="12"]</p>',
					'action'     	=> "<button class='btn-copycart button-primary' data-value='[eventbrite_events posts_per_page=\"12\"]' >Copy</button>",
		);
        $data[] = array(
                    'id'            => 4,
                    'how_to_use'    => 'Display Events based on order',
					'shortcode'     => '<p class="short_code">[eventbrite_events order="asc"]</p>',
					'action'     	=> "<button class='btn-copycart button-primary' data-value='[eventbrite_events order=\"asc\"]' >Copy</button>",
                    );
        $data[] = array(
                    'id'            => 5,
                    'how_to_use'    => 'Display events based on category',
					'shortcode'     => '<p class="short_code" >[eventbrite_events category="cat1"]</p>',
					'action'     	=> "<button class='btn-copycart button-primary' data-value='[eventbrite_events category=\"cat1\"]' >Copy</button>",
                    );
        $data[] = array(
                    'id'            => 6,
                    'how_to_use'    => 'Display Past events',
					'shortcode'     => '<p class="short_code">[eventbrite_events past_events="yes"]</p>',
					'action'     	=> "<button class='btn-copycart button-primary' data-value='[eventbrite_events past_events=\"yes\"]' >Copy</button>",
                    );
        $data[] = array(
                    'id'            => 7,
                    'how_to_use'    => 'Display Events based on orderby',
					'shortcode'     => '<p class="short_code">[eventbrite_events order="asc" orderby="post_title"]</p>',
					'action'     	=> "<button class='btn-copycart button-primary' data-value='[eventbrite_events order=\"asc\" orderby=\"post_title\"]' >Copy</button>",
                    );
        $data[] = array(
                    'id'            => 8,
                    'how_to_use'    => 'Full Short-code',
					'shortcode'     => '<p class="short_code">[eventbrite_events  col="2" posts_per_page="12" category="cat1" past_events="yes" order="desc" orderby="post_title" start_date="YYYY-MM-DD" end_date="YYYY-MM-DD"]</p>',
					'action'     	=> "<button class='btn-copycart button-primary' data-value='[eventbrite_events col=\"2\" posts_per_page=\"12\" category=\"cat1\" past_events=\"yes\" order=\"desc\" orderby=\"post_title\" start_date=\"YYYY-MM-DD\" end_date=\"YYYY-MM-DD\"]' >Copy</button>",
                    );       
        return $data;
    }
